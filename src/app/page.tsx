...
export default async function Home() {
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-x-4 gap-y-4 md:gap-x-4 py-6">
        {/* Feed */}
        {/* @ts-expect-error server component */}
        {session? <CustomFeed/> : <GeneralFeed />}

        {/* subiscuit info */}
        <div className="overflow-hidden h-fit rounded-lg border border-[#B6F7F7] order-first md:order-last ">
